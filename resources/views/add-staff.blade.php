...
<a class="nav-brand nav-link nav-link1 px-5">
  <img src="images/logo.png" width="130" height="60" alt="logo">
</a>
<div class="mx-auto">
...
<li class="nav-item nav-item1">
  <a class="nav-link nav-link1" href="/reg-customer">Customer Registration</a>
</li>
</ul>
</div>
</nav>
...
<form action="/add-staff" method="POST">
  <h1 class="logH1">Staff Registration</h1>
