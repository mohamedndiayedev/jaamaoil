...
<div class="row">
  <div class="col-4">
    <img src="/images/LPimg1.png" style="width: 90%; margin-top: 30px;"> 
    <img src="/images/newlogo.jpeg" style="width: 75%; margin-top: 30px;"> 

  </div>

  <div class="col-8">
    <img src="/images/landingpage2.png" style="width: 100%; margin-top: 50px;">
  </div>
</div>
