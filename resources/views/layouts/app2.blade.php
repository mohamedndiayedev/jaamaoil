  ...
  <img class="mainLogo" src="images/newlogo.jpeg"> 
    ...
    <div class="container master-div" style="position: relative">
        ...
        <div id="NavigationAndHeadingBox" class="row" style="padding-bottom:5px;">
            ...
            <div class="container master-div4 master-div6">

              <nav class="navbar navbar3">
              <ul class="nav justify-content-center">
              <span>   <img class="icon" src="images/customers.png" width="65" height="45"></span>
              <li class="nav-item nav-item3">
              <a class="nav-link nav-link3 active" href="{{ url('/manage-customers') }}">Customers</a>
              </li>

              <span>   <img class="icon" src="images/admin.png" width="58" height="40"></span>
              <li class="nav-item nav-item3">
              <a class="nav-link nav-link3" href="{{ url('/manage-admins') }}">Admins</a>
              </li>


              <span>   <img class="icon" src="images/staffs.png" width="65" height="45"></span>
              <li class="nav-item nav-item3">
              <a class="nav-link nav-link3" href="{{ url('/manage-staffs') }}">Staffs</a>
              </li>
