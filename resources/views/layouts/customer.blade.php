...
<body>
  ...
  <img class="mainLogo" src="images/newlogo.jpeg"> 
    ...
    <div class="col master-div2"><h1 class="master-h1">Hi, {{ Session::get('customer.name') }}</h1></div>
    <div class="master-div3">

    <nav class="navbar navbar-expand-lg navbar2">
    <ul class="nav justify-content-center">
      
        <span>   <img class="icons" src="images/listIcon.png" width="22" height="22"></span>
      <li class="nav-item nav-item2">
        <a class="nav-link nav-link2 active" href="/customer-home">Redeemed Vouchers</a>
      </li>   

      <span>   <img class="icons" src="images/listIcon.png" width="22" height="22"></span>
      <li class="nav-item nav-item2">
        <a class="nav-link nav-link2 active" href="/customer-vouchers?user=customer">Vouchers</a>
      </li>  

    <span>   <img class="icons" src="images/user.png" width="22" height="22"></span>
      <li class="nav-item nav-item2">
        <a class="nav-link nav-link2" href="/profile-customer">Profile</a>
      </li> 

      <span>   <img class="icons" src="images/logout.png" width="20" height="24"></span>
      <li class="nav-item nav-item2">
        <a class="nav-link nav-link2" href="{{ url('/logout') }}">Logout</a>
      </li>
